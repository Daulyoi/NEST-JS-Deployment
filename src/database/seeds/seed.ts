  ...
  try {
    ...
    await monthlyRepo.save([
      {
        ...
        behavioralFeatures: {
          ...
          top_needs_category: 'Tagihan & Utilitas',
          top_wants_category: 'F&B dan Nongkrong',
      ...
      },
      {
        ...
        behavioralFeatures: {
          ...
          top_needs_category: 'Tagihan & Utilitas',
          top_wants_category: 'Belanja Online & Fashion',
      ...
      },
      {
        ...
        behavioralFeatures: {
          ...
          top_needs_category: 'Tagihan & Utilitas',
          top_wants_category: 'Hiburan & Langganan',
    ...
    await anomalyRepo.save([
      ...
      },
      {
        ...
        subCategory: 'Belanja Online & Fashion',
        amount: 1_850_000,
        mae: 312.4,
        thresholdVal: 180.0,
        ratio: 4.63,
